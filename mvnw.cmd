...
@REM This is not required at all in windows
@REM set MAVEN_CONFIG=-s .m2/settings.xml --batch-mode --no-transfer-progress --color always -T 2
set MAVEN_CONFIG=-s .m2/settings.xml --batch-mode --color always -T 2
